        ...
        <div className="p-2">
          ...
          <div className="flex flex-col items-center justify-center gap-5 h-[500px]">
            {auth.user.role === 'Admin' ? (
              <>
                <a href={route('admin.dashboard')} className={linkClass(route().current('admin.dashboard'))}>
                  <FiGrid className='text-2xl'/>
                </a>
                <a href={route('admin.employee')} className={linkClass(route().current('admin.employee'))}>
                  <GoPeople className='text-2xl'/>
                </a>
                <a href={route('admin.payroll')} className={linkClass(route().current('admin.payroll'))}>
                   <img
                ...
                <a href={route('admin.payroll.summary')} className={linkClass(route().current('admin.payroll.summary'))}>
                  <img 
                ...
                <a href={route('admin.department')} className={linkClass(route().current('admin.department'))}>
                  <img 
                            className="w-6 h-6 "
              ...
              <div className="p-2 ">
                ...
                <div className="flex flex-col items-center  justify-center gap-5 h-[500px]">
                        <a href={route('employee.dashboard')} className={linkClass(route().current('admin.department'))}>
                            <FiGrid className='text-2xl text-white'/>
                        </a>
                        <a href={route('employee.payslip.summary')} className={linkClass(route().current('admin.department'))} >
