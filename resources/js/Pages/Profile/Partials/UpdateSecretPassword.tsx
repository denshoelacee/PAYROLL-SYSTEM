    ...
    return (
        <section className={className}>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="password" value="Secret Question" className='text-white'/>
                ...
                <div>
                    <InputLabel htmlFor="password_confirmation" value="New Secret Password" className='text-white' />
